...
let allproducts = new ProductManager_1.ProductManager();
let menu = new menu_1.Menu();
let choice = -1;
let product1 = new product_1.Product('tao', 1, 'TaoUc', 10000, 5000, 'Hoaqua nuoc ngoai', '20/6/2022');
let product2 = new product_1.Product('cam', 2, 'CamMy', 15000, 5000, 'Hoa qua nuoc ngoai', '21/6/2022');
let product3 = new product_1.Product('duahau', 3, 'DưaThai', 10000, 3000, 'Hoa qua nuoc ngoai', '24/6/2022');
let product4 = new product_1.Product('thanhlong', 4, 'thanhlongmientay', 15000, 1000, 'Hoa qua trong nuoc', '27/6/2022');
let product5 = new product_1.Product('dua', 5, 'Dừa miền Nam', 10000, 7000, 'Hoa qua trong nuoc', '29/6/2022');
...
function addNewProduct() {
    ...
    let newproduct = new product_1.Product(name, id, type, price, amount, discrible, date);
